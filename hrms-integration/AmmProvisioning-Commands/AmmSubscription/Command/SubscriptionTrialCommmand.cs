...
public record SubscriptionTrialCommmand : IRequest<ResultNew<AmmSubscriptionDTO>> 
{    
    public AmmSubscriptionDTO Dto {get;set;}
}
public class CreateAmmSubscriptionCommandValidator : AbstractValidator<SubscriptionTrialCommmand>
{
    public CreateAmmSubscriptionCommandValidator()
    {
...
public class CreateAmmSubscriptionCommandHandler : IRequestHandler<SubscriptionTrialCommmand, ResultNew<AmmSubscriptionDTO>>
{
    private readonly ILogger<SubscriptionTrialCommmand> _logger;
    ...
    public CreateAmmSubscriptionCommandHandler(
        ILogger<SubscriptionTrialCommmand> logger,
    ...
    public async Task<ResultNew<AmmSubscriptionDTO>> Handle(SubscriptionTrialCommmand command, CancellationToken cancellationToken)
    {
        _logger.LogInformation("Yep!! Inside ");
        Console.WriteLine("Yep!! Inside ");

               await _unitOfWork.BeginTransactionAsync();
        await _repository.Trial(command);
